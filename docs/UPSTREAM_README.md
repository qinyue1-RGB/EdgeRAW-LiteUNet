# Upstream AISP README

> Archived from the upstream [HuiiJi/AISP](https://github.com/HuiiJi/AISP) repository. Relative image paths were adjusted for the `docs/` location.
